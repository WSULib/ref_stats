...
<body>
	...
	<div id="breadcrumb" class="row">
		<div class="col-md-12 text-center">
			...
			<p><a class="btn btn-WSUgreen" href="../"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> RefStats Main Page</a> <a class="btn btn-WSUgreen" href="./list.php"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Manage Transactions</a> <a class="btn btn-WSUgreen" href="./reports.php"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> Reports</a></p>
		</div>
	</div>
